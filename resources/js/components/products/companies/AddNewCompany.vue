<template>
    <div>
        <a-drawer
            :title="__('default.add_new_company')"
            :width="720"
        ...
        >
            ...
            <template #footer>
                ...
                <a-button v-else type="primary" style="margin-right: 8px" @click.prevent="saveCategory">
...
export default {
    ...
    methods: {
        async saveCategory() {
            this.loading = true;
            await axios.post('/product/companies', this.formState.formData)
                .then(response => {
